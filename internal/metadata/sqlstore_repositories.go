...
type metadataSQLRepositories struct {
	...
	processingRecords *repositoryx.Base[model.ProcessingRecord, metadataProcessingRecordsSchema]
...
func newMetadataSQLRepositories(db *dbx.DB) metadataSQLRepositories {
	...
	return metadataSQLRepositories{
		...
		processingRecords: repositoryx.New[model.ProcessingRecord](db, metadataProcessingRecords.schema),
